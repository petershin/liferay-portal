...
GradleMissingDependenciesForUpgradeJava11Check | [Bug Prevention](bug_prevention_checks.markdown#bug-prevention-checks) | Checks missing dependencies for upgrade Java 11 in gradle build files. |
