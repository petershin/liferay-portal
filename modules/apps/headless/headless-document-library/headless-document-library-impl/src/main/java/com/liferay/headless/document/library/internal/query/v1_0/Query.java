...
public class Query {
	...
	@GraphQLField
	@GraphQLInvokeDetached
	public Collection<Document> getDocumentCategoriesPage( @GraphQLName("document-id") Long documentId , @GraphQLName("per_page") int perPage , @GraphQLName("page") int page ) throws Exception {
