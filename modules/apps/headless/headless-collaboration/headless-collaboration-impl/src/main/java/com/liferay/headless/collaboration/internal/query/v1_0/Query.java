...
package com.liferay.headless.collaboration.internal.query.v1_0;
...
public class Query {
	...
	@GraphQLField
	@GraphQLInvokeDetached
	public Collection<BlogPosting> getBlogPostingCategoriesPage( @GraphQLName("blog-posting-id") Long blogPostingId , @GraphQLName("per_page") int perPage , @GraphQLName("page") int page ) throws Exception {
