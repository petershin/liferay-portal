...
public class Query {
	...
	@GraphQLField
	@GraphQLInvokeDetached
	public Collection<ContentStructure> getContentSpaceContentStructuresPage( @GraphQLName("content-space-id") Long contentSpaceId , @GraphQLName("per_page") int perPage , @GraphQLName("page") int page ) throws Exception {

		return _getContentStructureResource().getContentSpaceContentStructuresPage( contentSpaceId , Pagination.of(perPage, page) ).getItems();
	...
	public ContentStructure getContentStructure( @GraphQLName("content-structure-id") Long contentStructureId ) throws Exception {
		...
		return _getStructuredContentResource().getContentStructure( contentStructureId );
	...
	@GraphQLField
	@GraphQLInvokeDetached
	public Collection<StructuredContent> getStructuredContentCategoriesPage( @GraphQLName("structured-content-id") Long structuredContentId , @GraphQLName("per_page") int perPage , @GraphQLName("page") int page ) throws Exception {
