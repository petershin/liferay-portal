...
public interface SearchContainerURLFactory {
	...
	public RenderURL create(
		Type type, Supplier<RenderURL> renderURLSupplier, int cur, int delta,
		String displayStyle, String keywords, String orderByCol,
		String orderByType, boolean resetCur);
