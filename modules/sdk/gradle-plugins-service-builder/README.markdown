...
buildscript {
	dependencies {
		classpath group: "com.liferay", name: "com.liferay.gradle.plugins.service.builder", version: "4.0.14"
	}

	repositories {
		maven {
			url "https://repository-linode.liferay.com/nexus/content/groups/public"
		}
	}
}
...
```gradle
dependencies {
	serviceBuilder group: "com.liferay", name: "com.liferay.portal.tools.service.builder", version: "1.0.343"
}
```
