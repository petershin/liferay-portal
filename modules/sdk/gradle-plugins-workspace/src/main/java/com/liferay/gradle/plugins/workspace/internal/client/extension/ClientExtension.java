...
public class ClientExtension {
	...
	private static final String _OBJECT_ACTION_PID =
		ClientExtension._OBJECT_PREFIX +
			"FunctionObjectActionExecutorFactoryConfiguration";

	private static final String _OBJECT_PREFIX =
		...
		new HashMap<>();
	{
		...
		_clientExtensionFactoryPids.put("objectAction", _OBJECT_ACTION_PID);
