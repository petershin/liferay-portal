...
public class FooImpl extends FooBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. All methods that expect a foo model instance should use the {@link foo.model.Foo} interface instead.
	 */
	public FooImpl() {
	}
