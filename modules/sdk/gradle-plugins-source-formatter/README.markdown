...
The plugin has been successfully tested with Gradle 2.14.1 up to 4.10.2.
...
buildscript {
	dependencies {
		classpath group: "com.liferay", name: "com.liferay.gradle.plugins.source.formatter", version: "2.3.280"
	}
...
```gradle
dependencies {
	sourceFormatter group: "com.liferay", name: "com.liferay.source.formatter", version: "1.0.754"
}
```
