 ...
 */
public class AddListFromFeatureDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.microsoft.schemas.sharepoint.soap.AddListFromFeatureDocument
{
    private static final long serialVersionUID = 1L;
    
    public AddListFromFeatureDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName ADDLISTFROMFEATURE$0 = 
     ...
     */
    public com.microsoft.schemas.sharepoint.soap.AddListFromFeatureDocument.AddListFromFeature getAddListFromFeature()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.sharepoint.soap.AddListFromFeatureDocument.AddListFromFeature target = null;
            target = (com.microsoft.schemas.sharepoint.soap.AddListFromFeatureDocument.AddListFromFeature)get_store().find_element_user(ADDLISTFROMFEATURE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAddListFromFeature(com.microsoft.schemas.sharepoint.soap.AddListFromFeatureDocument.AddListFromFeature addListFromFeature)
    {
        generatedSetterHelperImpl(addListFromFeature, ADDLISTFROMFEATURE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "AddListFromFeature" element
     */
    public com.microsoft.schemas.sharepoint.soap.AddListFromFeatureDocument.AddListFromFeature addNewAddListFromFeature()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.sharepoint.soap.AddListFromFeatureDocument.AddListFromFeature target = null;
            target = (com.microsoft.schemas.sharepoint.soap.AddListFromFeatureDocument.AddListFromFeature)get_store().add_element_user(ADDLISTFROMFEATURE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class AddListFromFeatureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.microsoft.schemas.sharepoint.soap.AddListFromFeatureDocument.AddListFromFeature
    {
        private static final long serialVersionUID = 1L;
        
        public AddListFromFeatureImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        private static final javax.xml.namespace.QName FEATUREID$4 = 
        ...
        public java.lang.String getFeatureID()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(FEATUREID$4, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public com.microsoft.wsdl.types.Guid xgetFeatureID()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.microsoft.wsdl.types.Guid target = null;
                target = (com.microsoft.wsdl.types.Guid)get_store().find_element_user(FEATUREID$4, 0);
                return target;
            }
        }
        ...
        public void setFeatureID(java.lang.String featureID)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(FEATUREID$4);
                }
                target.setStringValue(featureID);
            }
        }
         ...
         */
        public void xsetFeatureID(com.microsoft.wsdl.types.Guid featureID)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (com.microsoft.wsdl.types.Guid)get_store().add_element_user(FEATUREID$4);
                }
        ...
        public org.apache.xmlbeans.XmlInt xgetTemplateID()
        {
            synchronized (monitor())
            {
                ...
                target = (org.apache.xmlbeans.XmlInt)get_store().find_element_user(TEMPLATEID$6, 0);
                return target;
            }
        }
        ...
        public void xsetTemplateID(org.apache.xmlbeans.XmlInt templateID)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlInt)get_store().add_element_user(TEMPLATEID$6);
                }
