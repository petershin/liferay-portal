...
public class VersionsLocator extends org.apache.axis.client.Service implements com.microsoft.schemas.sharepoint.soap.Versions {
    ...
    private java.lang.String VersionsSoap12_address = "http://localhost/_vti_bin/Versions.asmx";
    ...
    private java.lang.String VersionsSoap_address = "http://localhost/_vti_bin/Versions.asmx";
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        if ("VersionsSoap12".equals(inputPortName)) {
            return getVersionsSoap12();
        }
        else if ("VersionsSoap".equals(inputPortName)) {
